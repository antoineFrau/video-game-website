...
module.exports =  function(db) {
    ...
    api.get('/:id/username', (req, res) => {
        const username = db.get('users')
            .find({ id: req.params.id })
            .value().username
        if (isEmpty(username))
            res.status(404).send(jsonError('User not found ! Please login in !'))
        res.send(jsonSuccessData('User found !', username))
    })
    ...
    api.post('/login', (req, res) => {
        ...
        res.send(jsonSuccessData('Sucessfuly connected !', u))
    })
    ...
    api.post('/signup', (req, res) => {
        ...
        res.send(jsonSuccessData('Successfuly created', u))
    })
    ...
    function generateName() {
        ...
        var name = capFirst(name1[getRandomInt(0, name1.length + 1)]) + '_' + capFirst(name2[getRandomInt(0, name2.length + 1)]);
        return name;
